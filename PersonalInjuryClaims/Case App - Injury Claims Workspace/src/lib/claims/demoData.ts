...
const CASE_0417: InjuryClaim = {
  ...
  priority: "P2",
  status: "Action required",
  currentStage: "Treatment Delivery & Provider Management",
  activeLanes: [],
  owner: "Dana Ferris",
  ownerRole: "Claims Officer",
  ...
  trail: [
    ...
    },
    {
      ...
      stage: "Treatment Delivery & Provider Management",
      time: "09:10 AM",
    },
    {
      seq: 3,
  ...
  activity: [
    ...
    },
    {
      ...
      level: "stage",
      actor: "Case manager",
      title: "Entered Treatment Delivery & Provider Management",
      detail: "Aldergate Claims Operations · 4 hr clock",
...
export const DEMO_INSIGHTS: OperationalInsights = {
  ...
  stageAccumulation: [
    ...
    { stage: "Treatment Delivery & Provider Management", cases: 7 },
